# activenture/user.py
from activenture import app, db, noti
...
from activenture.validation import (
    flask_bcrypt,
...
def login():
    ...
    from activenture.auth import is_user_logged_in
...
def admin_dashboard():
    try:
        ...
        from activenture.analytics import get_system_user_statistics, get_event_participation_insights, get_platform_monitoring_data, get_personal_activity_stats
...
def personal_activity():
    ...
    try:
        ...
        from activenture.analytics import get_personal_activity_stats
