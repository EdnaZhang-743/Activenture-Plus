...
from activenture import app
from flask import render_template, request, redirect, url_for, flash, session, jsonify
from activenture import db, noti
from activenture.auth import require_login, get_current_user_id
from activenture.util import AVAILABLE_LOCATIONS, PROFILE_ALLOWED_EXTENSIONS, save_uploaded_file, remove_uploaded_file
from activenture.validation import check_password, check_current_password, check_new_password_different
import re
